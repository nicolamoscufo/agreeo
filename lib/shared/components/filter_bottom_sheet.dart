              ...
              children: [
                  ...
                  children: [
                    ...
                    for (final g in widget.genres)
                      AgChip(
                        ...
                        onTap: () => setState(
                          () => _filters = _filters.copyWith(genre: g),
                        ),
                      ),
                  ],
                ),
                _Section(
                  ...
                  children: [
                    AgChip(
                      label: 'Any',
                      active: _filters.maxRuntimeMinutes == null,
                      onTap: () => setState(
                    ...
                    for (final m in const [90, 120, 150])
                      AgChip(
                        label: '${m}m',
                        active: _filters.maxRuntimeMinutes == m,
                        onTap: () => setState(
                          () => _filters = _filters.copyWith(
                            maxRuntimeMinutes: m,
                          ),
                ...
                _Section(
                  ...
                  children: [
                    AgChip(
                      label: 'Any',
                      active: _filters.minReleaseYear == null,
                      onTap: () => setState(
                        () => _filters = _filters.copyWith(
                          clearMinReleaseYear: true,
                        ),
                      ),
                    ),
                    for (final y in const [2015, 2020, 2023])
                      AgChip(
                        label: '$y+',
                        active: _filters.minReleaseYear == y,
                        onTap: () => setState(
                          () => _filters = _filters.copyWith(minReleaseYear: y),
                        ),
                      ),
                  ],
                ),
          ...
          children: [
            Expanded(
              child: AgButton.secondary(
                ...
                height: 50,
                onPressed: () =>
                    setState(() => _filters = const MovieSearchFilters()),
              ),
            ),
            ...
            Expanded(
              ...
              child: AgButton(
                label:
                    _activeCount == 0 ? 'Apply' : 'Apply · $_activeCount set',
                icon: AgIcons.check,
                height: 50,
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(title, style: AgText.h4.copyWith(fontSize: 14.5, color: t.text)),
